...
class _$_ReceiverInstituition implements _ReceiverInstituition {
  ...
  @override
  String toString() {
    return 'ReceiverInstituition(id: $id, name: $name, phoneNumber: $phoneNumber, emailAddress: $emailAddress, address: $address, fcmToken: $fcmToken)';
  }
...
abstract class _ReceiverInstituition implements ReceiverInstituition {
  const factory _ReceiverInstituition(
      ...
      required final String? fcmToken}) = _$_ReceiverInstituition;
